      ...
      <div className="px-4 space-y-4 fade-up">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          <Link href="/dashboard/publicar"
            className="card p-3 flex flex-col items-center gap-1.5 active:scale-95 transition-transform">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
              style={{ background: 'linear-gradient(135deg,#A864C0,#7C3F8E)', boxShadow: '0 4px 10px rgba(124,63,142,0.38)' }}>
              <ShareIcon />
            </div>
            <span className="text-[11px] font-semibold text-gray-800">Publicar</span>
          </Link>
